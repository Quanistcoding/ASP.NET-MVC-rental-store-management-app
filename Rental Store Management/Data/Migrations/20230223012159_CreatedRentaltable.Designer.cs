...
namespace Rental_Store_Management.Data.Migrations
{
    ...
    [Migration("20230223012159_CreatedRentaltable")]
    partial class CreatedRentaltable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rental_Store_Management.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Rental_Store_Management.Models.Rental", b =>
                {
                    ...
                    b.Property<string>("CustomerDriverLicenseNumber")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Rental_Store_Management.Models.Customer", b =>
                {
                    b.HasOne("Rental_Store_Management.Models.MembershipType", "MembershipType")
                        .WithMany()
            ...
            modelBuilder.Entity("Rental_Store_Management.Models.Movie", b =>
                {
                    b.HasOne("Rental_Store_Management.Models.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("Rental_Store_Management.Models.Rental", b =>
                {
                    b.HasOne("Rental_Store_Management.Models.Customer", "Customr")
                        .WithMany()
                        .HasForeignKey("CustomrId");

                    b.HasOne("Rental_Store_Management.Models.Movie", "Movie")
                        .WithMany()
